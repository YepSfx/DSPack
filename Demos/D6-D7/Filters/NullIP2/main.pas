...
uses
  BaseClass, ActiveX, DirectShow9, Windows, DXSUtil, prop;

const
  CLSID_NullInPlace        : TGUID = '{C79B7D63-905F-4D84-A59E-F9C9B3398DA8}';
  IID_INullIPP             : TGUID = '{3BA6B111-1C12-42DE-850E-6186D4A9BA0A}';

type

  INullIPP = interface(IunKnown)
  ['{3BA6B111-1C12-42DE-850E-6186D4A9BA0A}']
...
initialization
  TBCClassFactory.CreateFilter(TNullInPlace, '_Null-In-Place', CLSID_NullInPlace,
